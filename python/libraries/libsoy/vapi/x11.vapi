...
namespace X {
    ...
    public class Display {
        ...
        [CCode (cname = "XAutoRepeatOff")]
        public int auto_repeat_off ();

        [CCode (cname = "XAutoRepeatOn")]
        public int auto_repeat_on ();
        ...
        public int change_property (Window w, Atom property, Atom type,
                                    int format, int mode,
                                    [CCode (array_length = false)]
                                    uchar[] data, int nelements);

        [CCode (cname = "XChangeWindowAttributes")]
        public int change_window_attributes (Window w, ulong valuemask,
                                             SetWindowAttributes attributes);

        [CCode (cname = "XClearArea")]
        public int ClearArea (Window w, int x, int y, 
                              uint width, uint height, bool exposures);

        [CCode (cname = "XConfigureWindow")]
        public int configure_window (Window w, uint value_mask,
                                     WindowChanges values);

        [CCode (cname = "ConnectionNumber")]
        public int connection_number ();

        [CCode (cname = "XCreateWindow")]
        public Window create_window (Window parent, int x, int y, uint width,
                                     uint height, uint border_width, int depth,
                                     uint @class, Visual? visual,
                                     X.CW valuemask,
                                     ref SetWindowAttributes attributes);

        [CCode (cname = "XCreateImage")]
        public unowned Image create_image (Display display, Visual u,
        ...
        public int next_event (out Event event_return);
        ...
        [CCode (cname = "XPeekEvent")]
        public void peek_event (out Event event_return);
        ...
        public X.VisualInfo? get_visual_info (long vinfo_mask,
                                              X.VisualInfo? template,
    ...
    public struct ClientMessageEvent {
        ...
        public int format;
        [CCode (cname = "data.b", array_length = false)]
        public unowned char[] b;
        [CCode (cname = "data.s", array_length = false)]
