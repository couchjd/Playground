...
namespace EGL {
    ...
    public struct EGLConfig : int { }
    [CCode (cname="EGLContext")]
    public struct EGLContext : int { }
    [CCode (cname="EGLDisplay")]
    public struct EGLDisplay : int { }
    [CCode (cname="EGLSurface")]
    public struct EGLSurface : int { }
    [CCode (cname="EGLClientBuffer")]
    public struct EGLClientBuffer : int { }
    ...
    // Config attributes
    public const EGLint EGL_BUFFER_SIZE;
    public const EGLint EGL_ALPHA_SIZE;
    public const EGLint EGL_BLUE_SIZE;
    public const EGLint EGL_GREEN_SIZE;
    public const EGLint EGL_RED_SIZE;
    public const EGLint EGL_DEPTH_SIZE;
    public const EGLint EGL_STENCIL_SIZE;
    public const EGLint EGL_CONFIG_CAVEAT;
    public const EGLint EGL_CONFIG_ID;
    public const EGLint EGL_LEVEL;
    public const EGLint EGL_MAX_PBUFFER_HEIGHT;
    public const EGLint EGL_MAX_PBUFFER_PIXELS;
    public const EGLint EGL_MAX_PBUFFER_WIDTH;
    public const EGLint EGL_NATIVE_RENDERABLE;
    public const EGLint EGL_NATIVE_VISUAL_ID;
    public const EGLint EGL_NATIVE_VISUAL_TYPE;
    public const EGLint EGL_SAMPLES;
    public const EGLint EGL_SAMPLE_BUFFERS;
    public const EGLint EGL_SURFACE_TYPE;
    public const EGLint EGL_TRANSPARENT_TYPE;
    public const EGLint EGL_TRANSPARENT_BLUE_VALUE;
    public const EGLint EGL_TRANSPARENT_GREEN_VALUE;
    public const EGLint EGL_TRANSPARENT_RED_VALUE;
    public const EGLint EGL_NONE;
    public const EGLint EGL_BIND_TO_TEXTURE_RGB;
    public const EGLint EGL_BIND_TO_TEXTURE_RGBA;
    public const EGLint EGL_MIN_SWAP_INTERVAL;
    public const EGLint EGL_MAX_SWAP_INTERVAL;
    public const EGLint EGL_LUMINANCE_SIZE;
    public const EGLint EGL_ALPHA_MASK_SIZE;
    public const EGLint EGL_COLOR_BUFFER_TYPE;
    public const EGLint EGL_RENDERABLE_TYPE;
    public const EGLint EGL_MATCH_NATIVE_PIXMAP;
    public const EGLint EGL_CONFORMANT;

    // Config attribute values
    public const EGLint EGL_SLOW_CONFIG;
    public const EGLint EGL_NON_CONFORMANT_CONFIG;
    public const EGLint EGL_TRANSPARENT_RGB;
    public const EGLint EGL_RGB_BUFFER;
    public const EGLint EGL_LUMINANCE_BUFFER;
    
    // More config attribute values, for EGL_TEXTURE_FORMAT
    public const EGLint EGL_NO_TEXTURE;
    public const EGLint EGL_TEXTURE_RGB;
    public const EGLint EGL_TEXTURE_RGBA;
    public const EGLint EGL_TEXTURE_2D;
    
    // EGL_SURFACE_TYPE mask bits
    public const EGLint EGL_PBUFFER_BIT;
    public const EGLint EGL_PIXMAP_BIT;
    public const EGLint EGL_WINDOW_BIT;
    public const EGLint EGL_VG_COLORSPACE_LINEAR_BIT;
    public const EGLint EGL_VG_ALPHA_FORMAT_PRE_BIT;
    public const EGLint EGL_MULTISAMPLE_RESOLVE_BOX_BIT;
    public const EGLint EGL_SWAP_BEHAVIOR_PRESERVED_BIT;
    
    // EGL_RENDERABLE_TYPE mask bits
    public const EGLint EGL_OPENGL_ES_BIT;
    public const EGLint EGL_OPENVG_BIT;
    public const EGLint EGL_OPENGL_ES2_BIT;
    public const EGLint EGL_OPENGL_BIT;
    ...
    public const EGLint EGL_CONTEXT_CLIENT_VERSION;
...
#if PLATFORM_X11
    public static EGLDisplay eglGetDisplay (X.Display display_id);
#else
