        ...
        // edges
          ...
          sinf((float)PI/4),        0,                         cosf((float)PI/4),
           ...
           width + r * sinf((float)PI*7/16),    yl/2,    depth + r * cosf((float)PI*7/16),
               ...
               0.25f+tx1*3/4,                           0.5f,
               cosf((float)PI*7/16),      0,                      -sinf((float)PI*7/16),
