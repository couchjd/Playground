...
class soy.joints.Ball: soy.joints.Joint
    ...
    def override model_matrix_A ( ) : array of GLfloat
        ...
        _mtx = mult_matrix(_inverseRotationA, _mtx)
        _mtx = mult_matrix(_jointRotThetaA, _mtx)
        _mtx = mult_matrix(_jointRotPhiA, _mtx)
        return _mtx
    ...
    def override render ( alpha_stage : bool, view : array of GLfloat,
        ...
        // get model matrix
        model_A : array of GLfloat = self.model_matrix_A()

        // modelview matrix
        model_view_A : array of GLfloat[16] = self.mult_matrix(model_A, view)
        ...
        i : int = 0
        while self.material.enable(i, model_view_A, view, projection, lights,
                                    ambient)
        ...
        if bodyB is not null
            ...
            i = 0
            while self.material.enable(i, model_view_B, view, projection,
                                       lights, ambient)
