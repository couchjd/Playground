...
class soy.bodies.Portal : soy.bodies.Body
    ...
    def override render ( alpha_stage : bool, view : array of GLfloat,
        ...
        // save current matrix
        // FIXME GLSL1 glMatrixMode(GL_MODELVIEW)
        // FIXME GLSL1 glPushMatrix()

        // Lock so body can't be changed during render
        mutex.lock()

        // get model matrix
        //model : array of GLfloat = self.model_matrix() // (currently not used)
        ...
        // FIXME GLSL1 glVertexPointer(3, GL_FLOAT, (GLsizei) (sizeof(GLfloat) * 3), null)
        ...
        //mtx : array of GLfloat[16] = new array of GLfloat[16] //not used currently
        // FIXME GLSL1 glMatrixMode (GL_MODELVIEW)
        // FIXME GLSL1 glLoadIdentity()
        ...
        // FIXME GLSL1 glLoadMatrixf(mtx)

        // FIXME GLSL1 glClipPlanef(GL_CLIP_PLANE0, equation)
        // FIXME GLSL1 glEnable(GL_CLIP_PLANE0)
        ...
        // FIXME GLSL1 glDisable(GL_CLIP_PLANE0)
