/* soy.vapi generated by valac-0.22 0.22.1, do not modify. */

namespace soy {
	namespace actions {
		[CCode (cheader_filename = "soy-1/soy.h")]
		public class Action : GLib.Object {
			public struct hid_profile {
				public string name;
				public string[] axis;
			...
			public int hid_mode;
			public soy.actions.Action.hid_profile[] hid_profiles;
			public Action ();
			public soy.bodies.Body getTarget ();
			public virtual void hid_axis_value (int8 axis, float value);
			public virtual void hid_button_down (string button);
			public virtual void hid_button_up (string button);
			public virtual void hid_moved (int x, int y);
			public virtual void hid_text (string text);
			public virtual void hid_touch_down (string button, int x, int y);
			public virtual void hid_touch_drag (string button, int x, int y);
			public virtual void hid_touch_up (string button, int x, int y);
			public void setTarget (soy.bodies.Body target);
			public virtual string tp_repr ();
			public string profile { get; }
		}
		[CCode (cheader_filename = "soy-1/soy.h")]
		public class Hover : soy.actions.Action {
			public Hover (int targetX, int targetY, int targetW, int targetH);
			public override void hid_moved (int x, int y);
			public override string tp_repr ();
		}
		[CCode (cheader_filename = "soy-1/soy.h")]
		public class Jump : soy.actions.Action {
			public Jump (soy.bodies.Body target, soy.atoms.Vector vector);
			public void Jump (soy.bodies.Body target, soy.atoms.Vector vector);
			public override void hid_button_down (string button);
		}
		[CCode (cheader_filename = "soy-1/soy.h")]
		public class Look : soy.actions.Action {
			public Look (soy.bodies.Body target);
			public override void hid_axis_value (int8 axis, float value);
		}
		[CCode (cheader_filename = "soy-1/soy.h")]
		public class Select : soy.actions.Action {
			public Select (soy.actions.Action action, soy.scenes.Scene scene);
			public override void hid_touch_down (string button, int x, int y);
			public override string tp_repr ();
		}
		[CCode (cheader_filename = "soy-1/soy.h")]
		public class Thrust : soy.actions.Action {
			public Thrust (soy.bodies.Body tgt, soy.atoms.Vector vec);
			public override void hid_button_down (string button);
			public override void hid_button_up (string button);
		}
	}
	namespace atoms {
		[CCode (cheader_filename = "soy-1/soy.h")]
		...
		public class Rotation : GLib.Object {
			public Rotation (float w = 1.0f, float x = 0.0f, float y = 0.0f, float z = 0.0f);
			public soy.atoms.Rotation add (soy.atoms.Rotation other);
			public static bool cmp_eq (GLib.Object left, GLib.Object right);
			public static bool cmp_ne (GLib.Object left, GLib.Object right);
			public soy.atoms.Rotation conjugate ();
			public float dot (soy.atoms.Rotation other);
			public soy.atoms.Vector getLookAt ();
			public soy.atoms.Vector getUp ();
			public float length ();
			public soy.atoms.Rotation mul (soy.atoms.Rotation other);
			public float norm ();
			public void normalize ();
			public soy.atoms.Vector rotate (soy.atoms.Vector v);
			public new void @set (float w = 1.0f, float x = 0.0f, float y = 0.0f, float z = 0.0f);
			public soy.atoms.Vector toEuler ();
	...
	namespace bodies {
		...
		public class Billboard : soy.bodies.Body {
			...
			public override void render (bool alpha_stage, GL.GLfloat[] view, GL.GLfloat[] projection, soy.bodies.Light[] lights, GL.GLfloat[] ambient);
		...
		public class Body : GLib.Object {
			...
			public GL.GLushort[] calculateEdges (GL.GLfloat[] vertices, GL.GLushort[] indices);
			public GL.GLfloat[] calculate_model_view (GL.GLfloat[] model, GL.GLfloat[] view);
			...
			public virtual GL.GLfloat[] model_matrix ();
			...
			public virtual void render (bool alpha_stage, GL.GLfloat[] view, GL.GLfloat[] projection, soy.bodies.Light[] lights, GL.GLfloat[] ambient);
		...
		public class Camera : soy.bodies.Body {
			...
			public void project (GL.GLfloat aspect, int x, int y, int width, int height);
			public soy.atoms.Vector projectVector (soy.atoms.Vector v, float aspect);
			public override void set_mass (float density);
		...
		public class Light : soy.bodies.Body {
			...
			public static string light_glslf;
			public static string light_glslv;
	...
	namespace controllers {
		namespace graph {
			...
			namespace _space {
				...
				public class Int3Node : GLib.Object, soy.controllers.graph.INode {
					public Int3Node (soy.controllers.graph.SpaceGraph graph, soy.atoms.Position pos);
					public virtual void add_connection (soy.controllers.graph.INode other);
					public virtual Gee.List<soy.controllers.graph.Edge> get_edges ();
					public virtual uint hash ();
					public Int3Node.with_OffsetTriple (soy.controllers.graph.SpaceGraph graph, soy.controllers.graph._space.OffsetTriple offset);
					public Int3Node.with_int_offset (soy.controllers.graph.SpaceGraph graph, int x_offset, int y_offset, int z_offset);
					public int x { get; }
					public int y { get; }
					public int z { get; }
				}
				...
				[CCode (cheader_filename = "soy-1/soy.h")]
				public class TerminalNode : GLib.Object, soy.controllers.graph.INode {
					public TerminalNode (soy.controllers.graph.SpaceGraph graph, soy.atoms.Position pos, soy.controllers.graph._space.OffsetTriple[] connected);
					public virtual void add_connection (soy.controllers.graph.INode other);
					public virtual Gee.List<soy.controllers.graph.Edge> get_edges ();
				}
			}
			...
			[CCode (cheader_filename = "soy-1/soy.h")]
			public class SpaceGraph : soy.controllers.graph.AbstractGraph, soy.controllers.graph.IGraph {
				public SpaceGraph (soy.scenes.Scene scene, float granularity, soy.atoms.Position? center = null);
				public SpaceGraph._default (soy.scenes.Scene scene, float granularity, float radius, soy.atoms.Size? size, soy.atoms.Position? center);
				public virtual soy.controllers.graph.INode add_terminal_node (soy.atoms.Position pos);
				...
				public SpaceGraph.with_radius (soy.scenes.Scene scene, float granularity, float radius, soy.atoms.Position? center = null);
				public SpaceGraph.with_size (soy.scenes.Scene scene, float granularity, soy.atoms.Size size, soy.atoms.Position? center = null);
				public soy.atoms.Position center { get; }
				public float granularity { get; }
			}
			[CCode (cheader_filename = "soy-1/soy.h")]
		...
		public class Pointer : soy.controllers.Controller {
			...
			public signal void onMotion (soy.events.Motion e);
		}
		[CCode (cheader_filename = "soy-1/soy.h")]
	...
	namespace events {
		...
		public class ButtonPress : soy.events.Device {
			public ButtonPress (uint value, soy.controllers.Pointer _p);
			public static void addAction (string button, soy.actions.Action action);
			public void decodeKey (uint value);
			public void executeBinding ();
			public static void init ();
		}
		[CCode (cheader_filename = "soy-1/soy.h")]
		public class ButtonRelease : soy.events.Device {
			public ButtonRelease (uint value, soy.controllers.Pointer _p);
			public static void addAction (string button, soy.actions.Action action);
			public void decodeKey (uint value);
			public void executeBinding ();
			public static void init ();
		...
		public class KeyPress : soy.events.Device {
			public KeyPress (uint value, soy.controllers.Keyboard _k);
			public static void addAction (string key, soy.actions.Action action);
			public void decodeKey (uint value);
			public void executeBinding ();
			public static void init ();
		}
		...
		public class KeyRelease : soy.events.Device {
			public KeyRelease (uint value, soy.controllers.Keyboard _k);
			public static void addAction (string key, soy.actions.Action action);
			public void decodeKey (uint value);
			public void executeBinding ();
			public static void init ();
		...
		[CCode (cheader_filename = "soy-1/soy.h")]
		public class Motion : soy.events.Event {
			public int x;
			public int x_root;
			public int y;
			public int y_root;
			public Motion (int _x, int _y, int _x_root, int _y_root, soy.controllers.Pointer _p);
			public static void addAction (soy.actions.Action action);
	...
	namespace joints {
		...
		public class Ball : soy.joints.Joint {
			...
			public override GL.GLfloat[] model_matrix_A ();
			public override GL.GLfloat[] model_matrix_B ();
			public override void render (bool alpha_stage, GL.GLfloat[] view, GL.GLfloat[] projection, soy.bodies.Light[] lights, GL.GLfloat[] ambient);
		...
		public class Joint : GLib.Object {
			...
			public virtual GL.GLfloat[] model_matrix_A ();
			public virtual GL.GLfloat[] model_matrix_B ();
			public GL.GLfloat[] mult_matrix (GL.GLfloat[] a, GL.GLfloat[] b);
			public virtual void render (bool alpha_stage, GL.GLfloat[] view, GL.GLfloat[] projection, soy.bodies.Light[] lights, GL.GLfloat[] ambient);
	...
	namespace materials {
		...
		public class Colored : soy.materials.Material {
			public static string color_glslf;
			public static string color_glslv;
			public Colored (string? name = null);
			public override bool enable (int pass, GL.GLfloat[] mv, GL.GLfloat[] v, GL.GLfloat[] p, soy.bodies.Light[] lights, GL.GLfloat[] scene_ambient);
		...
		public class Material : GLib.Object {
			public static string basic_glslf;
			public static string basic_glslv;
			public GL.GLenum draw_mode;
			public bool translucent;
			public Material ();
			public virtual void disable ();
			public virtual bool enable (int pass, GL.GLfloat[] mv, GL.GLfloat[] v, GL.GLfloat[] p, soy.bodies.Light[] lights, GL.GLfloat[] scene_ambient);
		}
		[CCode (cheader_filename = "soy-1/soy.h")]
		public class Textured : soy.materials.Colored {
			public static string texture_glslf;
			public static string texture_glslv;
			...
			public void disable_texture (int id, ode.Matrix3? texmatrix, soy.textures.Texture? texture);
			public override bool enable (int pass, GL.GLfloat[] mv, GL.GLfloat[] v, GL.GLfloat[] p, soy.bodies.Light[] lights, GL.GLfloat[] scene_ambient);
		...
		[CCode (cheader_filename = "soy-1/soy.h")]
		public class Wireframed : soy.materials.Material {
			public static string wireframe_glslf;
			public static string wireframe_glslv;
			public Wireframed ();
			public override bool enable (int pass, GL.GLfloat[] mv, GL.GLfloat[] v, GL.GLfloat[] p, soy.bodies.Light[] lights, GL.GLfloat[] scene_ambient);
		}
	}
	...
	namespace scenes {
		...
		public class Landscape : soy.scenes.Scene {
			...
			public override void render_extra (GL.GLfloat[] view, GL.GLfloat[] projection, soy.bodies.Camera camera, soy.bodies.Light[] lights);
		...
		public class Planar : soy.scenes.Scene {
			public Planar (float offset, soy.materials.Material? material);
			public override void render_extra (GL.GLfloat[] view, GL.GLfloat[] projection, soy.bodies.Camera camera, soy.bodies.Light[] lights);
			public soy.materials.Material material { get; set; }
			public float scale { get; set; }
		}
		...
		public class Scene : GLib.Object {
			...
			public static string collide_glslf;
			public static string collide_glslv;
			...
			public GLib.Mutex mutex;
			public static string skybox_glslf;
			public static string skybox_glslv;
			public ode.spaces.Space space;
			public GL.GLfloat[] tslvs;
			public Scene ();
			public float[] body_distance (float[] xs, float[] ys, float[] zs, float xOrig, float yOrig, float zOrig);
			public float[] body_distance_squared (float[] xs, float[] ys, float[] zs, float xOrig, float yOrig, float zOrig);
			public virtual void body_remove (string key);
			public virtual void body_update (string key, soy.bodies.Body? value);
			...
			public virtual void collide (int x, int y, int width, int height);
			public void @delete (string key);
			public virtual void do_in_step ();
			public new soy.bodies.Body? @get (string key);
			public bool has_key (string key);
			public static GL.GLfloat[] perspective (GL.GLfloat fovy, GL.GLfloat aspect, GL.GLfloat zNear, GL.GLfloat zFar);
			public virtual void post_render (GL.GLfloat[] view, GL.GLfloat[] projection, soy.bodies.Camera camera, soy.bodies.Light[] lights);
			public virtual void pre_render (soy.bodies.Camera camera);
			public virtual void render (GL.GLfloat fov, GL.GLfloat aspect, GL.GLfloat znear, GL.GLfloat zfar, soy.bodies.Camera camera, int x, int y, int width, int height);
			public virtual void render_extra (GL.GLfloat[] view, GL.GLfloat[] projection, soy.bodies.Camera camera, soy.bodies.Light[] lights);
		...
		[CCode (cheader_filename = "soy-1/soy.h")]
		public class Space : soy.scenes.Scene {
			public Space (float size, float scale);
			public override void body_remove (string key);
			public override void body_update (string key, soy.bodies.Body? value);
			public bool get_active (string key);
			public soy.scenes.SpaceCell get_cell ();
			public float get_distance (string key);
			public bool get_keep (string key);
			public bool get_position (string key, float* x, float* y, float* z);
			public string? poll_removed ();
			public soy.scenes.SpaceCell? poll_transitions ();
			public override void post_render (GL.GLfloat[] view, GL.GLfloat[] projection, soy.bodies.Camera camera, soy.bodies.Light[] lights);
			public override void pre_render (soy.bodies.Camera camera);
			public void set_distance (string key, float distance);
			public void set_keep (string key, bool keep);
			public bool set_position (string key, float x, float y, float z);
		}
		[CCode (cheader_filename = "soy-1/soy.h")]
		public class SpaceBody : GLib.Object {
			public float distance;
			public bool keep;
			public soy.atoms.Position position;
			public float scale;
			public SpaceBody (float distance, bool keep);
		}
		[CCode (cheader_filename = "soy-1/soy.h")]
		public class SpaceCell : GLib.Object {
			public int x;
			public int y;
			public int z;
			public SpaceCell ();
			public void add (soy.scenes.SpaceCell other);
			public SpaceCell.from_position (soy.atoms.Vector position, float scale);
			public SpaceCell.from_xyz (int x, int y, int z);
			public bool isNull ();
			public soy.atoms.Vector vector (float scale);
		}
		[CCode (cheader_filename = "soy-1/soy.h")]
	...
	namespace textures {
		...
		public class Bumpmap : soy.textures.Texture {
			public Bumpmap ();
			public Bumpmap.emboss (soy.textures.Texture texture, float strength = 0.5f);
			public Bumpmap.from_jpg (string filename) throws IOError, MemoryError;
		...
		public class Heightmap : soy.textures.Texture {
			public Heightmap ();
			public Heightmap.from_jpg (string filename) throws IOError, MemoryError;
		...
		[CCode (cheader_filename = "soy-1/soy.h")]
		public class SVGTexture : soy.textures.Texture {
			public SVGTexture ();
			public override void enable ();
		...
		public class Texture : GLib.Object {
			...
			public bool updated;
			public Texture ();
			public void copySurface (Cairo.ImageSurface surface);
			public virtual void disable ();
			public virtual void enable ();
			public Texture.from_jpg (string filename) throws IOError, MemoryError, GLib.Error;
			...
			public uchar[] generate_lerped_colors (int c1, int c2, int divisor);
			...
			public virtual GL.GLfloat[] texture_matrix ();
	...
	namespace widgets {
		...
		public class Canvas : soy.widgets.Widget {
			...
			public float aspect;
			public static string canvas_glslf;
			public static string canvas_glslv;
		...
		[CCode (cheader_filename = "soy-1/soy.h")]
		public class Console : soy.widgets.Widget {
			public soy.widgets.Canvas canvas;
			public int child_pid;
			public string command;
			public GLib.IOChannel error;
			public Gee.ArrayList<string> io;
			public GLib.IOChannel output;
			public int standard_error;
			public int standard_output;
			public string working_directory;
			public Console (string? working_directory, string? command);
			public override void add (soy.widgets.Container parent);
			public override void remove ();
			public override void render (int x, int y, int width, int height);
			public void renderText (int x, int y, int width, int height);
		...
		public class Window : soy.widgets.Container {
			...
			public uint windowid__ { get; }
		}
	}
	[CCode (cheader_filename = "soy-1/soy.h")]
	public class IteratorWrapper<G> : GLib.Object, Gee.Traversable<G> {
