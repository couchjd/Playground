...
"\n"
"    This base class is for generic, invisible, collision-less bodies.\n"
"\n"
"    While they have no shape they still have volume, mass, position,\n"
"    velocity, orientation, are influenced by fields, and may be connected\n"
"    to other bodies with a joint.\n"
"\n"
"    Example::\n"
"\n"
"        scene = soy.scenes.Scene()\n"
"        scene['body'] = soy.bodies.Body()\n"
"        scene['body'].position = soy.atoms.Position(5, 10, 15)\n"
"        scene['body'].rotation = soy.atoms.Rotation(0, 180, 90)\n"
"        scene['body'].velocity = soy.atoms.Vector(5, 0, 0)\n"
"        scene['body'].addTorque(0.00005,  0.000000,  0.00003)\n"
"        scene['body'].addForce(0.00001, 0, 0)\n"
"\n";
...
static char
addRelForce_doc[] = ".. py:method:: Body.addRelForce(x, y, z)\n"
"\n"
"    Add force (linear force) along given axis relative to the current orientation\n"
"\n"
"    :param float x: x axis\n"
"    :param float y: y axis\n"
"    :param float z: z axis\n"
...
static PyObject*
addRelForce (SELF self, PyObject* args) {
    float x, y, z;

    if (!PyArg_ParseTuple(args, "fff", &x, &y, &z))
        return NULL;

    soy_bodies_body_addRelForce(self->g, x, y, z);
...
static PyMethodDef tp_methods[] = {
    {"addForce",                                           // ml_name
     ...
     addForce_doc},                                        // ml_doc
    {"addRelForce",                                        // ml_name
     (PyCFunction) addRelForce,                            // ml_meth
     METH_VARARGS,                                         // ml_flags
     addRelForce_doc},                                     // ml_doc
    {"addTorque",                                          // ml_name
