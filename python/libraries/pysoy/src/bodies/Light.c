...
"        >>> scene['light'] = soy.bodies.Light()\n"
"        >>> scene['light'].diffuse = soy.atoms.Color('pink')\n"
"\n"
...
"        >>> scene = soy.scenes.Scene()\n"
"        >>> scene['light'] = soy.bodies.Light()\n"
"        >>> scene['light'].specular = soy.atoms.Color('white')\n"
"\n"
...
"    a texture. A texture is required for rendering.\n"
"\n"
"        >>> scene = soy.scenes.Scene()\n"
"        >>> scene['light'] = soy.bodies.Light()\n"
"        >>> scene['light'].size = 0.5\n"
"\n"
...
"        >>> scene = soy.scenes.Scene()\n"
"        >>> scene['light'] = soy.bodies.Light()\n"
"        >>> scene['light'].texture = soy.textures.Texture('filename.png')"
"            # doctest:+SKIP\n"
"\n"
":param texture: Texture\n"
