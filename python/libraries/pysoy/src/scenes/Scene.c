...
"\n"
"    Scenes store bodies in an ordered set which overwrites previous keys\n"
"    if a new value collides with a previous one.\n"
"\n"
...
mp_ass_subscript (SELF self, PyObject* key, PyObject* value) {
    ...
    if (value == NULL) {
        soy_scenes_scene_delete(self->g, PyBytes_AsString(name));
...
static char
keys_doc[] = "Return keys of the scene which correspond to the scene's bodies\n"
"\n"
"Example::\n"
"\n"
"    >>> s = soy.scenes.Scene()\n"
"    >>> s['cube'] = soy.bodies.Box()\n"
"    >>> s.keys()\n"
"    ['cube']\n";
...
static char
values_doc[] = "Return bodies of the scene\n"
"\n"
"Example::\n"
"\n"
"    >>> s = soy.scenes.Scene()\n"
"    >>> s['totem_pole'] = soy.bodies.Cylinder()\n"
"    >>> s.values()\n"
"    [<Cylinder>]\n";
...
static char
ambient_doc[] = "..py:attribute:: Ambient(ambient)\n"
"\n"
":param ambient: Ambient light for the scene to display with\n"
":type ambient: soy.atoms.Color\n"
"\n"
...
"        >>> s.ambient\n"
"        <Color (127, 127, 127, 255)>\n"
"        >>> s.ambient = soy.atoms.Color((198, 24, 3, 255))\n"
"        >>> s.ambient\n"
"        <Color (198, 24, 3, 255)>\n"
"\n";
...
static char
fog_doc[] = "..py:attribute:: Fog(fog)\n"
"\n"
":param fog: Color of the fog. alpha decides its density\n"
":type fog: soy.atoms.Color\n"
"\n"
"    Scene fog\n"
"\n"
...
"        >>> s.fog\n"
"        <Color (0, 0, 0, 0)>\n"
"        >>> s.fog = soy.atoms.Color((255, 0,  0, 7))\n"
"        >>> s.fog\n"
"        <Color (255, 0, 0, 7)>\n";
...
static char
gravity_doc[] = "..py:attribute:: Gravity(gravity)\n"
"\n"
":param gravity: Vector force to constantly apply to all objects\n"
":type gravity: soy.atoms.Vector\n"
"\n"
"    Scene gravity\n"
"\n"
...
"        >>> s.gravity\n"
"        <Vector (0.000000, 0.000000, 0.000000)>\n"
"        >>> s.gravity = soy.atoms.Vector((0.0, -9.8, 0.0))\n"
"        >>> s.gravity\n"
"        <Vector (0.000000, -9.800000, 0.000000)>\n";
PYSOY_PROP_OBJECT_OWNED(scenes, scene, gravity, atoms_Vector)

static char
skybox_doc[] = ".. py:attribute:: Skybox(skybox)\n"
"\n"
":param skybox: Skybox to be displayed in the scene\n"
":type skybox: soy.textures.Cubemap\n"
"\n"
"    Scene skybox\n"
"\n"
