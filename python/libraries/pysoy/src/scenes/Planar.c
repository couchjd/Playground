...
static char
tp_doc[] = ".. py:class:: Planar([offset[, material]])\n"
"\n"
...
"    Example::\n"
"\n"
"        >>> p = soy.scenes.Planar(offset=8.0, material=soy.materials.Colored())\n"
"        >>> p\n"
"        <Planar>\n"
"\n"
"    :param offset: Distance the plane is rendered below 0 on the y axis\n"
"    :type offset: float\n"
"    :param material: Material that the floor plane should use\n"
"    :type material: soy.atoms.Material\n"
"\n";
...
tp_new (PyTypeObject* type, PyObject* args, PyObject* kwds) {
    ...
    static char* kw[] = {"offset", "material", NULL};

    // Parse arguments
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "|fO!", kw,
            &offset,
    ...
    // new gobject
    self->g = soy_scenes_planar_new(offset, material);
...
tp_repr (SELF self) {
    ...
    ret = PyUnicode_FromString("<Planar>");
...
"\n"
"    Example::\n"
"        >>> p = soy.scenes.Planar(material = soy.materials.Colored())\n"
"        >>> p.material\n"
"        <Colored>\n"
"        >>> p.material = soy.materials.Material()\n"
"        >>> p.material\n"
"        <Material>";
