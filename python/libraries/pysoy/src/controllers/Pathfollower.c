...
"Very important class for navigators! This is the successor of VirtualController\n"
"\n"
"the initializer for this class has the following signature::\n"
"\n"
"    soy.controllers.Pathfollower(scene, controlled, speed, fuzziness = None, paused = False, path)\n"
"\n"
"================ ====================================== ================================================================================================================================\n"
...
"================ ====================================== ================================================================================================================================\n"
"\n"
"    :param position: The list of waypoints to follow\n"
"    :type position: list or iterator of soy.atoms.Position\n"
"    :param speed: The speed of the object in ____ per ____\n"
"    :type speed: float\n"
"    :param finished: True then this finished. It is readonly prop\n"
"    :type finished: bool\n"
"    :param paused: Paused property\n"
"    :type paused: bool\n"
"    :param fuzziness: Fuzziness property\n"
"    :type fuzziness: bool\n"
"\n"
"\n"
"Examples::\n"
...
"   controller = soy.controllers.Pathfollower(scene, body, 0.1, (soy.atoms.Position((10,10,10)), soy.atoms.Position((-3,5,12)), soy.atoms.Position((0,0,0))))\n"
"\n"
...
"   controller = soy.controllers.Pathfollower(scene, body, 0.1, switcher(soy.atoms.Position((10,10,10)), soy.atoms.Position((0,0,0))))\n"
"\n";
