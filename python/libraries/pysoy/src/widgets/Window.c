...
static int
__windowid___setter (SELF self, PyObject* value, void* closure);
...
static char
__windowid___doc[] = ".. py:attribute:: __windowid__ \n"
"\n"
"The X11 XWindow ID\n"
"\n";

static PyObject*
__windowid___getter(SELF self, void* closure) {
    // returns the X11 XWindow as a PyObject integer
    return PyLong_FromLong((long) soy_widgets_window_get_windowid__(self->g));
}
