...
PyMODINIT_FUNC PyInit_soy_actions(void);

// soy.actions.Action
PyTypeObject PySoy_actions_Action_Type;
typedef struct {
    PyObject_HEAD
    soyactionsAction* g;
} PySoy_actions_Action_Object;
#define PySoy_actions_Action_Check(op) \
    PyObject_TypeCheck(op, &PySoy_actions_Action_Type)

// soy.actions.Hover
PyTypeObject PySoy_actions_Hover_Type;
typedef struct {
    PyObject_HEAD
    soyactionsHover* g;
} PySoy_actions_Hover_Object;
#define PySoy_actions_Hover_Check(op) \
    PyObject_TypeCheck(op, &PySoy_actions_Hover_Type)
...
typedef struct {
    PyObject_HEAD
    soyactionsJump* g;
} PySoy_actions_Jump_Object;
#define PySou_actions_Jump_Check(op) \
    PyObject_TypeCheck(op, &PySoy_actions_Jump_Type)
...
typedef struct {
    PyObject_HEAD
    soyactionsLook* g;
} PySoy_actions_Look_Object;
#define PySoy_actions_Look_Check(op) \
    PyObject_TypeCheck(op, &PySoy_actions_Look_Type)
...
typedef struct {
    PyObject_HEAD
    soyactionsSelect* g;
} PySoy_actions_Select_Object;
#define PySoy_actions_Select_Check(op) \
    PyObject_TypeCheck(op, &PySoy_actions_Select_Type)

// soy.actions.Thrust
PyTypeObject PySoy_actions_Thrust_Type;
typedef struct {
    PyObject_HEAD
    soyactionsThrust* g;
} PySoy_actions_Thrust_Object;
#define PySoy_actions_Thrust_Check(op) \
    PyObject_TypeCheck(op, &PySoy_actions_Thrust_Type)
...
PyMODINIT_FUNC PyInit_soy_events(void);
...
typedef struct {
    PyObject_HEAD
    soyeventsEvent* g;
} PySoy_events_Event_Object;
#define PySoy_events_Event_Check(op) \
    PyObject_TypeCheck(op, &PySoy_events_Event_Type)

// soy.events.ButtonPress
PyTypeObject PySoy_events_ButtonPress_Type;
typedef struct {
    PyObject_HEAD
    soyeventsButtonPress* g;
} PySoy_events_ButtonPress_Object;
#define PySoy_events_ButtonPress_Check(op) \
    PyObject_TypeCheck(op, &PySoy_events_ButtonPress_Type)

// soy.events.ButtonRelease
PyTypeObject PySoy_events_ButtonRelease_Type;
typedef struct {
    PyObject_HEAD
    soyeventsButtonRelease* g;
} PySoy_events_ButtonRelease_Object;
#define PySoy_events_ButtonRelease_Check(op) \
    PyObject_TypeCheck(op, &PySoy_events_ButtonReleae_Type)

// soy.events.KeyPress
PyTypeObject PySoy_events_KeyPress_Type;
typedef struct {
    PyObject_HEAD
    soyeventsKeyPress* g;
} PySoy_events_KeyPress_Object;
#define PySoy_events_KeyPress_Check(op) \
    PyObject_TypeCheck(op, &PySoy_events_KeyPress_Type)

// soy.events.KeyRelease
PyTypeObject PySoy_events_KeyRelease_Type;
typedef struct {
    PyObject_HEAD
    soyeventsKeyRelease* g;
} PySoy_events_KeyRelease_Object;
#define PySoy_events_KeyRelease_Check(op) \
    PyObject_TypeCheck(op, &PySoy_events_KeyRelease_Type)

// soy.events.Motion
PyTypeObject PySoy_events_Motion_Type;
typedef struct {
    PyObject_HEAD
    soyeventsMotion* g;
} PySoy_events_Motion_Object;
#define PySoy_events_Motion_Check(op) \
    PyObject_TypeCheck(op, &PySoy_events_Motion_Type)
...
typedef struct {
    PyObject_HEAD
    soyscenesSpace* g;
} PySoy_scenes_Space_Object;
#define PySoy_scenes_Space_Check(op) \
    PyObject_TypeCheck(op, &PySoy_scenes_Space_Type)
...
// soy.textures.SVGTexture
PyTypeObject  PySoy_textures_SVGTexture_Type;
typedef struct {
    PyObject_HEAD
    soytexturesSVGTexture* g;
} PySoy_textures_SVGTexture_Object;
#define PySoy_textures_SVGTexture_Check(op) \
    PyObject_TypeCheck(op, &PySoy_textures_SVGTexture_Type)
...
typedef struct {
    PyObject_HEAD
    soywidgetsConsole* g;
} PySoy_widgets_Console_Object;
#define PySoy_widgets_Console_Check(op) \
    PyObject_TypeCheck(op, &PySoy_widgets_Console_Type)
